...
//
// Source: CashCatSelfBurnerV2.sol, via `npm run sync:abis`.
...
export const selfBurnerAbi = [
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "hook_",
        "type": "address",
        "internalType": "contract CashCatHookV2"
      },
      {
        "name": "factory_",
        "type": "address",
